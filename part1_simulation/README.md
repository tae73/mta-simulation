...
**핵심 결과 한눈에** — 메인 방법론이 내놓는 두 산출물:

<p align="center">
  <img src="../results/part1/02_channel_credit.png" alt="채널 credit assignment — BackElim vs Shapley, Spearman ρ=0.929" width="640">
  <br><sub><b>그림 2 · 채널 credit assignment.</b> 같은 IPP 위 두 연산자(BackElim·Shapley)가 매긴 채널 인과 기여도 —
  Paid Search·Email 이 상위, 순위 합의 ρ=0.929(robust). <i>이 방법론의 1차 산출물.</i></sub>
</p>
<p align="center">
  <img src="../results/part1/02_path_topk.png" alt="multi-path 기여도 — 35개 robust 여정 Top-K" width="900">
  <br><sub><b>그림 3 · multi-path 기여도.</b> path-level Incremental Shapley로 ranking한 35개 robust 여정.
  total contribution 상위는 짧고 빈번한 Email→Paid Search(n=37)·Direct→Paid Search(n=24); mean Δ 상위는 드물지만 강한 3-step 여정.</sub>
</p>
...
두 연산자의 채널 **순위 합의도는 Spearman ρ = 0.929**(위 **그림 2**) — 합의가 높으면 보고 가능한 robust 신호, 크게
